...
- `README.md`: Anleitung und Präregistrierung.
...
- B2 hat keinen Effekt; die Manipulation ist für Wikipedia-Absätze zu schwach.
...
1. **Textquelle prüfen:** Die Beispieltexte sind alte Wikipedia-Artikel, der Hauptlauf lief also vermutlich mit dem Wikipedia-Dump 2023 statt mit `wiki_texte.py`. Für GPT-2 ist das weniger kritisch, weil WebText Wikipedia ausgeschlossen hat. Für Pythia (Pile enthält Wikipedia) unbedingt neue Artikel verwenden.
2. **Pythia-Lauf (H3)** mit neuen Artikeln.
